        ...
        function process() {
            ...
            switch (req.method.toUpperCase()) {
                ...
                case 'PUT':
                    ...
                    break
                case 'GET':
                    if (slug === 'list') promise = _this.scheduler.list({ before: query.before, after: query.after, failed: parseBool(query.failed) })
...
function parseBool(val) {
    return !['f', 'false', '0'].includes(String(val).toLowerCase())
}
