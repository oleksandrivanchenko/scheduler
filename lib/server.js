...
if (slug === 'test') { // TODO TODO TODO
        ...
        function process() {
            ...
            switch (req.method.toUpperCase()) {
                ...
                case 'GET':
                    ...
                    else if (slug === 'list') promise = _this.scheduler.list(query.before, query.after)
                    else {
                        res.statusCode = 404
                        return res.end()
                    }
    ...
    request() { return arguments[0].protocol.includes('https') ? https.request(...arguments) : http.request(...arguments) }
