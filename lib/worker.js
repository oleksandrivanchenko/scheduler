...
class Worker extends EventEmitter {
    constructor({ name = 'Worker', redis, running = true }) {
        ...
        if (Settings.verbose) winston.info('Finished constructing ' + name)
...
console.log('Worker#execute', body)
            _this.emit('done', event, typeof body === 'object' ? body : null)
