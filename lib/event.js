...
function formatFields(obj, trim = true) {
    ...
    if (obj.recurring != null) {
        if (typeof obj.recurring === 'object') {
            result.recurring = {
                years: obj.recurring.years ? parseInt(obj.recurring.years, 10) : 0,
                months: obj.recurring.months ? parseInt(obj.recurring.months, 10) : 0,
                weeks: obj.recurring.weeks ? parseInt(obj.recurring.weeks, 10) : 0,
                days: obj.recurring.days ? parseInt(obj.recurring.days, 10) : 0,
                hours: obj.recurring.hours ? parseInt(obj.recurring.hours, 10) : 0,
                minutes: obj.recurring.minutes ? parseInt(obj.recurring.minutes, 10) : 0,
                seconds: obj.recurring.seconds ? parseInt(obj.recurring.seconds, 10) : 0,
                milliseconds: obj.recurring.milliseconds ? parseInt(obj.recurring.milliseconds, 10) : 0
            }
        } else {
